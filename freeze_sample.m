...
% Decided this is a bad idea because it breaks idemptoency, at least
% in a practical sense.  You don't ever want to re-verify files that you've
% verified.  Just leave the certificates in place until there's a problem.
%
