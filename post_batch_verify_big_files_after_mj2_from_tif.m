function post_batch_verify_big_files_after_mj2_from_tif(mj2_output_folder_name, tif_input_folder_name)
    ...
    [verified_ok_mj2_count, problem_mj2_paths] = ...
        post_batch_verify_big_files_after_mj2_from_tif_helper(mj2_output_folder_name, ...
...
function [verified_ok_mj2_count, problem_mj2_paths] = ...
    ...
    for i = 1 : tif_input_entity_count ,
        ...
        if tif_input_entity.isdir ,
            ...
            [verified_ok_mj2_count, problem_mj2_paths] = ...
                post_batch_verify_big_files_after_mj2_from_tif_helper(mj2_output_entity_path, ...
